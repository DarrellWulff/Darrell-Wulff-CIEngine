...
{
	constructor(aspect=1, viewRadians=Math.PI/4, near=0.01, far=1000.0, moveSpeed=0.1, turnSpeed=0.015, position=new Vector(), rotation=new Quaternion())
	{
		super(aspect, viewRadians, near, far, position, rotation);
